...
/**
 * Implement BPR with dynamic sampling.
 * Zhang, Chen, et al. "Optimizing top-n collaborative filtering via dynamic negative item sampling" 
 * 
 * 
 * @author guanghuiyu
 *
 */
public class bpr_dns extends TopKRecommender {
	/** Model priors to set. */
  ...
  Random rand = new Random();
	public bpr_dns(SparseMatrix trainMatrix, ArrayList<Rating> testRatings,
    ...
    //if (Double.isNaN(mult) || Math.abs(grad_u)>100000|| Math.abs(grad)>1000  ) {
